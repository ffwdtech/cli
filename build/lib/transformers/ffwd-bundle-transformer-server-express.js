...
function runTransformersOnFileStreamItem(_a) {
    var file = _a.file, files = _a.files, options = _a.options;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    generated = _b.sent();
                    fileAsModule = requireFromString(generated.code, file.path);
                    if (fileAsModule.hi)
                        fileAsModule.hello();
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    src.errors(function (err) {
                            ...
                            push(null, H(new Promise(function (res, rej) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _a = res;
                                            return [4 /*yield*/, runTransformersOnFileStreamItem({ file: file, files: files, options: options })];
                                        case 1:
                        ...
                        return __generator(this, function (_a) {
                            if (!files[FFWDFunctionType.Route])
                                files[FFWDFunctionType.Route] = [];
                            if (!files[FFWDFunctionType.Method])
