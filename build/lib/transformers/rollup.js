    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    bundle = _b.sent();
                    return [4 /*yield*/, bundle.generate(options.outputOptions)];
                case 2:
                    generated = _b.sent();
                    code = generated && generated.code ? generated.code : "";
                    base = files[0].cwd + "/" + path.parse(options.outputOptions.file).dir;
                    filePath = options.outputOptions.file;
                    returnFiles = [
                        new Vinyl({
                            cwd: files[0].cwd,
                            base: base,
